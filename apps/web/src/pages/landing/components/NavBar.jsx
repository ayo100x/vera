    ...
    <nav className="fixed top-0 inset-x-0 z-50 bg-vera-offwhite/90 backdrop-blur-md border-b border-vera-border">
      <div className="max-w-7xl mx-auto px-5 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-10 text-sm text-vera-gray">
          <a href="#discover" className="hover:text-vera-black transition">
            Discover
          </a>
          <a href="#how" className="hover:text-vera-black transition">
            How it works
          </a>
          <a href="#sellers" className="hover:text-vera-black transition">
            For sellers
          </a>
        </div>
        <div className="flex items-center gap-4">
          ...
          <button className="bg-vera-black text-white text-sm px-5 py-2.5 rounded-full hover:bg-black transition">
            Try VERA
          </button>
